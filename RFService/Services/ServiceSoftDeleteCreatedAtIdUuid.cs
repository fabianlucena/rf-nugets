...
{
    public abstract class ServiceSoftDeleteCreatedAtIdUuid<TRepo, TEntity>(TRepo repo)
        : ServiceSoftDeleteCreatedAtId<TRepo, TEntity>(repo),
            IServiceSoftDelete<TEntity>
        where TRepo : IRepo<TEntity>
        where TEntity : EntitySoftDeleteCreatedAtIdUuid
    {
