...
{
    public abstract class ServiceSoftDeleteLogIdUuid<TRepo, TEntity>(TRepo repo)
        : ServiceSoftDeleteLogId<TRepo, TEntity>(repo),
            IServiceUuid<TEntity>
        where TRepo : IRepo<TEntity>
        where TEntity : EntitySoftDeleteLogIdUuid
    {
