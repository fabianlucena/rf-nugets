...
namespace RFService.IServices
{
        ...
        where Entity : class
    {
        ...
        Task<Entity> GetSingleForIdAsync(Int64 id, GetOptions? options = null);

        Task<Entity?> GetSingleOrDefaultForIdAsync(Int64 id, GetOptions? options = null);

        Task<IEnumerable<Entity>> GetListForIdsAsync(IEnumerable<Int64> id, GetOptions? options = null);
