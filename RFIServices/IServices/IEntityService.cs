    ...
    where T : Entity
{
    ...
    Task<T?> GetSingleOrDefaultByIdAsync(long id, EntityQueryOptions? options = null);
    Task<T> GetSingleByUuidAsync(Guid uuid, EntityQueryOptions? options = null);
    Task<T?> GetFirstOrDefaultByUuidAsync(Guid uuid, EntityQueryOptions? options = null);
    Task<T?> GetSingleOrDefaultByUuidAsync(Guid uuid, EntityQueryOptions? options = null);
    Task<IEnumerable<long>> GetListIdAsync(EntityQueryOptions options);
    Task<IEnumerable<Guid>> GetListUuidAsync(EntityQueryOptions options);
